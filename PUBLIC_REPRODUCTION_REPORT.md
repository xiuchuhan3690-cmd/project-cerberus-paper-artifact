...
- Result: **13/13 public-derivative checks PASS**, 0 failures, 0 errors, test process exit 0; selected Python source compilation exit 0. Wall-clock for both commands: 0.367 seconds; unittest execution: 0.019 seconds. The clean copy contained 125 non-cache files.
